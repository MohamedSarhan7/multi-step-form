...
const Stepper = ({ steps, currentStep }) => {
    ...
    const displaySteps = newStep.map((step, index) => {
        return (
            <div key={index}
                ...
                <div
                    ...
                    <div className={`rounded-full transition duration-500 
                        ease-in-out border-2 border-gray-300 h-12 w-12 flex justify-center
                        items-center py-3 font-medium 
                        ${step.selected
            ...
            ease-in-out ${step.completed ? "border-green-600" : "border-gray-300"}`}></div>
            </div>)
    }
